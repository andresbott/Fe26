...
.fe26-file-list .p-button.btn-default,
.fe26-file-list .p-button.btn-default:hover {
    background: #dedede;
    color: #636972;
}

.fe26-file-list .p-button.btn-go-code,
.fe26-file-list .p-button.btn-go-code:hover {
    background: #2db6da;
    color: #ffffff;
}
.fe26-file-list .p-button.btn-img,
.fe26-file-list .p-button.btn-img:hover {
    background: #11b98c;
    color: #ffffff;
}
.fe26-file-list .p-button.btn-js-code,
.fe26-file-list .p-button.btn-js-code:hover {
    background: #da892d;
    color: #ffffff;
}

.fe26-file-list .p-button.btn-pdf,
.fe26-file-list .p-button.btn-pdf:hover {
    background: #c50000;
    color: #ffffff;
}
</style>
...
function fmtTime(input) {
    return DateTime.fromSeconds(input).toFormat('dd.MM.yy HH:mm')
}
